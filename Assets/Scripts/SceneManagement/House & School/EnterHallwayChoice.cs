...
public class EnterHallwayChoice : MonoBehaviour
{
    ...
    {
        if (GameManager.Instance.lastScene == "Bedroom Choice")
        {
        ...
        if (GameManager.Instance.lastScene == "Bathroom Choice")
        {
        ...
        if (GameManager.Instance.lastScene == "Parent Choice")
        {
